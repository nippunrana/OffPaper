...
<section class="auth">
  <div class="container auth__grid">
    <div class="auth__panel">
      ...
      <a class="btn btn--google btn--block" href="/auth/google/start.php">
      ...
      <form class="auth-form <?= $mode === 'login' ? 'is-active' : '' ?>" data-panel="login" method="post" action="/login.php" novalidate>
      ...
      <form class="auth-form <?= $mode === 'signup' ? 'is-active' : '' ?>" data-panel="signup" method="post" action="/login.php" novalidate>
        <input type="hidden" name="csrf" value="<?= e(csrf_token()) ?>">

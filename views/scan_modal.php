<?php
/**
 * Document Scanning Pop-over Modal Component
 */
?>
<meta name="csrf-token" content="<?= e(csrf_token()) ?>">

<div id="scanModal" class="scan-modal" role="dialog" aria-modal="true" aria-labelledby="scanModalTitle">
  <div class="scan-modal__dialog">
    <div class="scan-modal__header">
      <h2 id="scanModalTitle">Scan a Document</h2>
      <button type="button" class="scan-modal__close" data-close-scan-modal aria-label="Close modal">&times;</button>
    </div>
